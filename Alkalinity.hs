...
-- Units for mineral content of water
data MineralUnit = Unit_mmolPerLiter      -- ^ mmol/l
...
carbonateAlkalinity :: Double -> MineralUnit -> Double
...
calciumAlkalinity :: Double -> MineralUnit -> Double
...
magnesiumAlkalinity :: Double -> MineralUnit -> Double
